...
export const CARBON_INTENSITY_G_PER_KWH = 40;
export const TREE_CO2_ABSORPTION_KG_PER_YEAR = 21;
// TO-DO: Change this based on past metrics
export const MAX_JOULES = 500;
...
export const PLACEHOLDERS = {
    ...
    cpuCaption: "Calculates CPU utilization by recent builds"
};
